...
class AboutControlStatements(Koan):
    ...
    def test_for_statement_with_tuples(self):
        ...
        # text = "Contestant: '[^']*'   Answer: '[^']*'"
        # text = "Contestant: '{0}'   Answer: '{1}'"
        text = result[2]

        # self.assertRegex(result[2], text.format(round_table[2][0], round_table[2][1]))
        # self.assertRegex(result[2], text.format(round_table[2][0], round_table[2][1]))
        ...
        # self.assertNotRegex(result[0], text.format(round_table[0][0], round_table[0][1]))
        # self.assertNotRegex(result[1], text.format(round_table[1][0], round_table[1][1]))
        # self.assertNotRegex(result[3], text.format(round_table[3][0], round_table[3][1]))
