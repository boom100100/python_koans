...
class AboutSets(Koan):
    ...
    def test_creating_sets_using_strings(self):
        ...
        self.assertEqual({'5', '2', '1', '3', '4'}, set('12345'))
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual({'Willie'}, scotsmen - warriors) #what only scotsmen has
        self.assertEqual({'MacLeod', 'Wallace', 'Willie', 'Leonidas'}, scotsmen | warriors) #combine them both
        self.assertEqual({'MacLeod', 'Wallace'}, scotsmen & warriors) #what they have in common
        self.assertEqual({'Willie', 'Leonidas'}, scotsmen ^ warriors) #what they don't have in common
